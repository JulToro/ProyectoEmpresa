...
namespace Ecommerce.ShippingExito.Tracking.Infrastructure.Data.Extensions
{
        ...
        public class SprocResults
        {
            ...
            private IList<T> MapToList<T>(DbDataReader dr)
            {
                ...
                var colMapping = dr.GetColumnSchema()
                    .Where(x => props.Any(y => string.Equals(y.Name, x.ColumnName, StringComparison.OrdinalIgnoreCase)))
